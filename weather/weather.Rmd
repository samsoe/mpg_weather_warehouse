...
Many other weather variables are available. For a list and description, please see the [Readme](https://docs.google.com/document/d/1WKzE0v4DiwlfKYjMvTEVgzp_-_6jAv4l4CAtqqy-aII/edit?usp=sharing).

##### Hardware

The weather stations are made by Davis Instruments, model [Vantage Pro 2](https://www.davisinstruments.com/vantage-pro2/tech-specs/). The network infrastructure that facilitates the weather stations was designed and is maintained by Nick Franczyk and Gus Seward. 
